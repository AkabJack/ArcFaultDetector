...
void ADC1_Initialize(void)
{
    ...
    AD1SWTRG = 0x0UL;
    //TRG1SRC SCCP1 Trigger Event; SAMC 6.5 TAD; NINSEL disabled; LEFT Integer; PINSEL AD1AN0; DIFF disabled; CMPMOD NONE; TRG2SRC Immediate re-trigger request back-to-back conversions; EIEN disabled; TRG1POL disabled; ACCRO disabled; ACCBRST disabled; ACCNUM 4 samples, 13 bits result; MODE Single sample initiated by TRG1SRC[4:0] trigger; 
    AD1CH0CON = 0x10006CUL;
